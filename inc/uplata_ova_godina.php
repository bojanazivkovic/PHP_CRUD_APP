...
$id_suosnivac = $_POST['id_suosnivac_uplata_ove'];
$datum_uplate = $_POST['datum_uplate_ove'];
$datum_uplate = str_replace(' ', '', $datum_uplate);
$datum_uplate = str_replace(',', '.', $datum_uplate);
$datum_uplate = str_replace('/', '.', $datum_uplate);

$datum_uplate_za_pravo_glasa = date('Y-m-d', strtotime($datum_uplate));
$datum_uplate = date('Y-m-d H:i:s', strtotime($datum_uplate));

$pravo_glasa = Pravoglasa::getGlasanje($id_suosnivac,$datum_uplate_za_pravo_glasa);
$id_pravo_glasa = $pravo_glasa['id'];
...
if($godina_uplate > 2016){
		try{
			...
			if($id_pravo_glasa != null || $id_pravo_glasa != ''){
				Pravoglasa::updatePravo($id_pravo_glasa);
				Pravoglasa::updatePravoOdDatumaNadalje($id_suosnivac, $datum_uplate_za_pravo_glasa);
			}
